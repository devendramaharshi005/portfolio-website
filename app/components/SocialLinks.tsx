  ...
  return (
    <section className="py-8 flex flex-col items-center">
      ...
      <div className="flex space-x-4">
        <Link href="https://github.com/devendramaharshi005" className="text-foreground hover:text-primary text-2xl">
          <AiFillGithub />
        </Link>
        <Link href="https://linkedin.com/in/devendra-maharshi-995704212" className="text-foreground hover:text-primary text-2xl">
          <AiFillLinkedin />
        </Link>
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <Link href="https://linkedin.com/in/devendra-maharshi-995704212" className="flex items-center space-x-2 text-foreground hover:text-primary">
        ...
        <Link href="https://www.geeksforgeeks.org/user/jony2102001/" className="flex items-center space-x-2 text-foreground hover:text-primary">
